...
- GET  /v1/models                  — lists agent-o as an available model
...
AnythingLLM, NextChat, ChatBox, etc.) can connect to agent-o
...
def _hermes_version() -> str:
    """Return the agent-o version string, or "dev" if it can't be resolved.
...
class APIServerAdapter(BasePlatformAdapter):
    ...
    and routes them through agent-o's AIAgent.
    """
    ...
    async def _handle_health(self, request: "web.Request") -> "web.Response":
        ...
        return web.json_response(
            {"status": "ok", "platform": "agent-o", "version": _hermes_version()}
        )
    ...
    async def _handle_models(self, request: "web.Request") -> "web.Response":
        """GET /v1/models — return agent-o as an available model."""
