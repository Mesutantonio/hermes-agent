...
_PLATFORMS = [
    # All consumer messaging platform entries removed for Agent O.
    # The only supported built-in platform is Microsoft Teams, which is
    # discovered dynamically via the platform registry from
    # plugins/platforms/teams/adapter.py::register().
    # Webhook (non-human triggers) is configured separately via hermes setup webhook.
]
